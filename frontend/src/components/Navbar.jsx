...
import { Sword, User, LogOut, Trophy, Sun, Moon, BookOpen } from 'lucide-react';
          ...
          <div className="flex items-center space-x-6">
            ...
            {user ? (
              <>
                ...
                <Link to="/codex" className="text-sm font-bold text-gray-600 dark:text-gray-300 hover:text-yellow-500 dark:hover:text-yellow-400 transition-colors uppercase tracking-wider flex items-center gap-1">
