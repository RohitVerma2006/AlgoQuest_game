...
import { Shield, Sword, Star, Trophy, Target, BookOpen } from 'lucide-react';
        ...
        <div className="bg-white dark:bg-gradient-to-r dark:from-[#2a2a2a] dark:to-[#1a1a1a] rounded-2xl border border-gray-200 dark:border-gray-800 p-8 mb-8 flex items-center gap-8 shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10 flex-grow">
            ...
            <div className="flex gap-6">
              ...
              <Link to="/codex" className="bg-indigo-50 dark:bg-indigo-900/30 hover:bg-indigo-100 dark:hover:bg-indigo-900/50 px-4 py-2 rounded-lg border border-indigo-200 dark:border-indigo-700 flex items-center gap-3 transition-colors cursor-pointer">
                <BookOpen className="w-5 h-5 text-indigo-500" />
                <div>
                  <div className="text-xs text-indigo-500 dark:text-indigo-400 uppercase tracking-wider">Learning Hub</div>
                  <div className="font-bold text-indigo-700 dark:text-indigo-300">Library</div>
                </div>
              </Link>
            </div>
          </div>
